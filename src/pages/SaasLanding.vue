    ...
    <v-navigation-drawer v-model="mobileDrawer" location="right" temporary class="pa-4">
      <div class="d-flex flex-column gap-4 mt-4">
        <div class="d-flex align-center gap-3 mb-6 px-2">
          ...
          <span class="text-subtitle-1 font-weight-black text-indigo-darken-4">HWNix Solutions</span>
        </div>
          ...
          <v-row align="center">
            <v-col cols="12" md="7">
              ...
              <div class="d-flex gap-4 justify-end flex-wrap">
                <v-btn size="x-large" color="amber-darken-2" class="rounded-md px-10 font-weight-black" to="/register" height="56">
                  ابدأ تجربتك المجانية
                </v-btn>
                <v-btn size="x-large" variant="outlined" color="white" class="rounded-md px-10 font-weight-black" height="56">
                  تعرف على المميزات
                </v-btn>
              </div>
            </v-col>
      ...
      <section class="py-16 bg-white">
        <v-container>
          <v-card color="indigo-darken-4" class="rounded-md pa-12 text-center shadow-xl overflow-hidden" elevation="10">
            ...
            <v-btn size="x-large" color="amber-darken-2" class="rounded-md px-12 font-weight-black position-relative" height="60" to="/register">
              سجل حسابك مجاناً
            </v-btn>
          </v-card>
        </v-container>
