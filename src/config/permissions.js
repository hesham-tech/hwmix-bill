...
export const PERMISSION_GROUPS = {
  ...
  // Can manage HWNix Cash
  CAN_MANAGE_HWNIX_CASH: [
    PERMISSIONS.HWNIX_CASH_VIEW_ALL,
    PERMISSIONS.HWNIX_CASH_CREATE,
    PERMISSIONS.HWNIX_CASH_EDIT_ALL,
    PERMISSIONS.HWNIX_CASH_DELETE_ALL,
    PERMISSIONS.HWNIX_CASH_MESSAGES_VIEW_ALL,
    PERMISSIONS.HWNIX_CASH_WALLET_TRANSACTIONS_VIEW_ALL,
    PERMISSIONS.HWNIX_CASH_WALLET_TRANSACTIONS_CREATE,
    PERMISSIONS.HWNIX_CASH_MESSAGE_SOURCES_VIEW_ALL,
    PERMISSIONS.HWNIX_CASH_MESSAGE_SOURCES_CREATE,
  ],
};
