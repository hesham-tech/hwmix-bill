  ...
  <div class="pa-4">
    ...
    <div class="d-flex align-center justify-space-between mb-4">
      ...
      <div class="d-flex gap-3 align-center flex-wrap">
        <div v-if="selectedPeriod === 'custom'" class="d-flex align-center gap-2">
          <v-text-field prefix="من:" type="date" v-model="dateFrom" density="compact" variant="outlined" hide-details @update:model-value="fetchData" style="width: 150px;" class="bg-white rounded-lg"></v-text-field>
          <v-text-field prefix="إلى:" type="date" v-model="dateTo" density="compact" variant="outlined" hide-details @update:model-value="fetchData" style="width: 150px;" class="bg-white rounded-lg"></v-text-field>
        </div>
