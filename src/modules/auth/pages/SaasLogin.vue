    ...
    <div class="saas-login-container">
      ...
      <div class="saas-brand-panel">
        <div class="saas-brand-inner">
          ...
          <p class="saas-subtext">انضم لآلاف الشركات التي تعتمد على HWNix في إدارة فواتيرها، مخازنها، وتقاريرها المالية بكل سهولة وأمان.</p>
      ...
      <div class="saas-form-panel">
        <div class="saas-form-inner">
          <router-link to="/saas" class="saas-back-link"> <i class="ri-arrow-right-line"></i> العودة للرئيسية </router-link>
          ...
          <v-form ref="formRef" @submit.prevent="handleLogin" class="saas-form">
            ...
            <div class="saas-remember-row">
              <v-checkbox v-model="form.remember" label="تذكرني" color="warning" density="comfortable" hide-details class="saas-checkbox" />
            </div>

            <AppButton type="submit" color="warning" size="x-large" block active :loading="loading" class="saas-login-btn">
...
.saas-input :deep(.v-field__input) {
  color: white !important;
}
.saas-input :deep(.v-icon) {
  color: rgba(255, 255, 255, 0.4) !important;
}
.saas-input :deep(input::placeholder) {
