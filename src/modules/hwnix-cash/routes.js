...
export default [
  {
    path: 'hwnix-cash',
    redirect: '/app/hwnix-cash/dashboard',
  },
  {
    path: 'hwnix-cash/dashboard',
    name: 'hwnix-cash-dashboard',
    component: () => import('@/modules/hwnix-cash/pages/HwnixCashDashboard.vue'),
    meta: {
      title: 'لوحة تحكم كاش هونكس',
      permission: [
