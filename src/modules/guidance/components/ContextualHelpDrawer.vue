...
const defaultHelpContent = {
  ...
  '/app/settings/company': {
    ...
    description: 'تحكم في هوية المنشأة وتفضيلات الطباعة وخيارات المنشأة وتكوينات النظام المختلفة.',
  },
  '/app/users': {
    title: 'إدارة المستخدمين',
    description: 'تتيح لك هذه الشاشة إدارة حسابات فريق عملك وتحديد فروعهم وصلاحياتهم بدقة لضمان أمان النظام.',
  },
  '/app/roles': {
    title: 'إدارة الأدوار والصلاحيات',
    description: 'تحكم بمنظومة الصلاحيات في النظام. يسمح لك بإنشاء أدوار مخصصة وتحديد الصلاحيات الدقيقة لكل دور لضمان أعلى معايير الأمان لمنشأتك.',
  },
  'default': {
