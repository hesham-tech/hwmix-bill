    ...
    <v-card v-if="showFilters" class="mb-3 rounded-lg border shadow-sm px-3 py-1">
      <div class="d-flex gap-3 align-center flex-wrap">
        ...
        <v-btn-toggle v-model="selectedPeriod" mandatory color="primary" variant="outlined" divided density="compact" class="rounded-lg" style="height: 28px;">
          <v-btn value="today" class="px-6 text-caption" style="height: 28px;">اليوم</v-btn>
          <v-btn value="week" class="px-6 text-caption" style="height: 28px;">الأسبوع</v-btn>
          <v-btn value="month" class="px-6 text-caption" style="height: 28px;">الشهر</v-btn>
        </v-btn-toggle>
      </div>
    </v-card>
