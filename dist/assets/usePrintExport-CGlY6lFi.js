import{r as c}from"./index-a34Ydvtq.js";function y(){const i=c(!1),s=c(!1);return{isPrinting:i,isExporting:s,printElement:(t,r="Document")=>{i.value=!0;const o=document.getElementById(t);if(!o){console.error(`Element with id ${t} not found`),i.value=!1;return}const e=window.open("","_blank");e.document.write(`
      <html>
        <head>
          <title>${r}</title>
          <style>
